            ...
            <section className="xl:grid grid-cols-[50%,50%] min-h-screen">
                <div className="w-full pt-[160px] justify-center flex px-[25px] sm:px-0">
                    <div className="relative w-[460px]">
                        ...
                        <div class="mt-[25px] rounded-[10px] bg-[#13121B] border border-[#5E5784] p-[25px]">
                            <p className=" text-[18px] leading-tight text-white text-left mx-auto font-normal">
                                Забыли пароль? Какая досада, ну ничего страшного, в нашей системе можно легко восстановить пароль, для этого необходимо ввести почту от вашего аккаунта.
                            </p>
                        </div>
                        <ForgotPasswordForm/>
                    </div>
