...
import ForgotPasswordThreeForm from "@/app/auth/forgot-password-three/components/ForgotPasswordThreeForm";
                    ...
                    <div className="relative w-[460px]">
                        ...
                        <div className="mt-[25px] rounded-[10px] bg-[#13121B] border border-[#5E5784] p-[25px]">
                            <p className=" text-[18px] leading-tight text-white text-left mx-auto font-normal">
                                Отлично! Теперь введите ваш новый пароль.
                            </p>
                        </div>
                        <ForgotPasswordThreeForm/>
