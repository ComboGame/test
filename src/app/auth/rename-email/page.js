...
import RenameEmailForm from "@/app/auth/rename-email/components/RenameEmailForm";
...
export default function RenameEmail() {
    return (
                    ...
                    <div className="relative w-[460px]">
                        ...
                        <div className="mt-[25px] rounded-[10px] bg-[#13121B] border border-[#5E5784] p-[25px]">
                            <p className=" text-[18px] leading-tight text-white text-left mx-auto font-normal">
                                Введите новую электронную почту для вашего аккаунта.
                                <br/><br/>Аккаунт: <span className="font-semibold text-white">_elue</span>
                            </p>
                        </div>
                        <RenameEmailForm/>
